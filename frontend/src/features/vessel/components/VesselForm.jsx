...
// Field Config
const vesselFields = [
    { name: 'vesselname', label: 'Vessel Name', type: 'text', gridSize: { xs: 12 } },
    { name: 'vessel_category', label: 'Category', type: 'text', gridSize: { xs: 12, sm: 6 } },
    { name: 'vesseltype', label: 'Type', type: 'text', gridSize: { xs: 12, sm: 6 } },
    { name: 'imo_Number', label: 'IMO Number', type: 'text', gridSize: { xs: 12, sm: 6 } },
    ...
    { name: 'vesselOwner', type: 'hidden' },
]

const VesselForm = ({ initialData = {}, onClose = () => { } }) => {
